...
export default function AcessoriosPage() {
     ...
     const [addedProducts, setAddedProducts] = useState(() => {
        const savedAddedProducts = localStorage.getItem('addedProductsAcessorios');
    ...
    // Filtra produtos da categoria acessorios
    const categoryProducts = produtos.filter(product => product.category === 'acessorios');


    // NOVO: Hook para salvar produtos adicionados no localStorage sempre que mudar
    useEffect(() => {
        localStorage.setItem('addedProductsAcessorios', JSON.stringify(Array.from(addedProducts)));
    }, [addedProducts]);
        ...
        <>
            ...
            <ProductContainer>
                <TitleContainer>
                    ...
                    <Description>Explore nossa coleção de acessórios tecnológicos de alta qualidade. Encontre tudo que você precisa para complementar seus dispositivos.</Description>
                </TitleContainer>
