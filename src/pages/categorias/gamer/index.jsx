...
export default function GamerPage() {
     ...
     const [addedProducts, setAddedProducts] = useState(() => {
        const savedAddedProducts = localStorage.getItem('addedProductsGamer');
     ...
     // Filtra produtos da categoria gamer
     const categoryProducts = produtos.filter(product => product.category === 'gamer');


     // NOVO: Hook para salvar produtos adicionados no localStorage sempre que mudar
     useEffect(() => {
         localStorage.setItem('addedProductsGamer', JSON.stringify(Array.from(addedProducts)));
     }, [addedProducts]);
    ...
    return (
        <>
            ...
            <ProductContainer>
                <TitleContainer>
                    <TitlePage>Gamer</TitlePage>
                    <Description>Descubra nossa seleção de produtos gamer premium. Consoles, periféricos e acessórios de última geração para melhorar sua experiência de jogo.</Description>
                </TitleContainer>
